...
**Every cryptographic step is an `openssl` invocation.** capping contributes JSON, temp files and process handling — nothing more. It has no runtime dependencies at all.
